                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-float border border-white text-center space-y-6 relative overflow-hidden flex-1 flex flex-col justify-center">
                            ...
                            <div className="py-4 relative group w-full min-h-[80px]">
                                <>
                                    ...
                                    <a
                                        href={`https://test.checkout.dodopayments.com/buy/pdt_0NVdAxwLfQ0jcf8GSwoVd?quantity=1&redirect_url=${encodeURIComponent(window.location.origin)}&metadata.user_id=${user?.id}`}

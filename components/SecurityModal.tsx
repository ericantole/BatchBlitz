        ...
        <div className="p-8 space-y-6">
            ...
            <div className="grid gap-4">
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-ink-main text-sm uppercase tracking-wide">Air-Gapped Logic</h3>
                        <p className="text-sm text-ink-muted mt-1">
                            The processing pipeline has no network permissions. Even if you lose internet connection, BatchBlitz continues to work perfectly.
                        </p>
                    </div>
                </div>
            </div>
